...
class CNN:
    """
    This is a class for edge-detection convolutional neural network
    ...
    def predict(self):
        ...
        for i in range(int(self.N_train * 0.9)):
            # Perform a sanity check on some random training samples
            plt.imsave("../Training_Data/Training_Prediction/prediction_{0}.png".format(i+1),
                       np.squeeze(preds_train_t[i]), cmap='gray')
